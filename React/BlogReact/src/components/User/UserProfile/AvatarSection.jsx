  ...
  return (
    <div className="mb-4 relative group w-fit">
      ...
      {isAuthor && (
        <Trash
          size={25}
          className="absolute top-1 left-0 text-red-500 bg-white dark:bg-gray-800 rounded-full p-1 opacity-0 group-hover:opacity-100 transition cursor-pointer shadow-md"
          onClick={deleteImage}
        />
      )}
